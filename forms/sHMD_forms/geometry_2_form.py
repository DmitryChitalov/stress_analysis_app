		...
		if os.path.exists(geometry_1_path_file):
			...
			for el in obj_list:
				if el['geometry_' + str(i)] == 'Набор базовых фигур' or el['geometry_' + str(i)] == 'Base shape complex':
					...
					complex_shape_table = QTableWidget()
					...
					while k <= sn:
						...
						#scale#
						scale_x_lbl = QLabel('x:')
						scale_y_lbl = QLabel('y:')
						scale_z_lbl = QLabel('z:')
						...
						complex_shape_scale_cell_widget = QWidget()
						...
						#origin#
						origin_x_lbl = QLabel('x:')
						origin_y_lbl = QLabel('y:')
						origin_z_lbl = QLabel('z:')
						...
						complex_shape_origin_cell_widget = QWidget()
						...
						complex_shape_e1_cell_widget = QWidget()
						...
						complex_shape_e3_cell_widget = QWidget()
				...
				if el['geometry_' + str(i)] == 'Три-поверхность' or el['geometry_' + str(i)] == 'Tri-surface':
					...
					while z <= rn:
						...
						column_dinamic = QTableWidgetItem()
				...
				if el['geometry_' + str(i)] == 'Распределенная три-поверхность' or el['geometry_' + str(i)] == 'Distributed tri-surface':
					...
					distrib_tri_table = QTableWidget()
					...
					distribution_tri_type_edit = QComboBox()
					...
					distrib_tri_name_edit = QLineEdit()
				...
				if el['geometry_' + str(i)] == 'Базовая фигура' or el['geometry_' + str(i)] == 'Base shape':
					...
					if el['shape_type_' + str(i)] == 'сфера' or el['shape_type_' + str(i)] == 'sphere':
						...
						#centre#
						centre_x_lbl = QLabel('x:')
						centre_y_lbl = QLabel('y:')
						centre_z_lbl = QLabel('z:')
						...
						sphere_centre_cell_widget = QWidget()
						sphere_centre_cell_widget.setLayout(centre_hbox)

						#radius#
						sphere_radius_edit = QLineEdit()
					...
					if el['shape_type_' + str(i)] == 'цилиндр' or el['shape_type_' + str(i)] == 'cylinder':
						...
						#point1#
						point1_x_lbl = QLabel('x:')
						point1_y_lbl = QLabel('y:')
						point1_z_lbl = QLabel('z:')

						point1_x = QLineEdit()
						cylinder_point1_validator = QRegExpValidator(QtCore.QRegExp("\-?\\d*\\.\\d+"))
						...
						cylinder_point1_cell_widget = QWidget()
						cylinder_point1_cell_widget.setLayout(point1_hbox)

						#point2#
						point2_x_lbl = QLabel('x:')
						point2_y_lbl = QLabel('y:')
						point2_z_lbl = QLabel('z:')
						...
						cylinder_point2_cell_widget = QWidget()
						cylinder_point2_cell_widget.setLayout(point2_hbox)
						#radius#
						cylinder_radius_edit = QLineEdit()
					...
					if el['shape_type_' + str(i)] == 'плоскость' or el['shape_type_' + str(i)] == 'plane':
						...
						#basePoint#
						basePoint_x_lbl = QLabel('x:')
						basePoint_y_lbl = QLabel('y:')
						basePoint_z_lbl = QLabel('z:')

						basePoint_x = QLineEdit()
						...
						plane_basePoint_cell_widget = QWidget()
						plane_basePoint_cell_widget.setLayout(basePoint_hbox)

						#normalVector#
						normalVector_x_lbl = QLabel('x:')
						normalVector_y_lbl = QLabel('y:')
						normalVector_z_lbl = QLabel('z:')

						normalVector_x = QLineEdit()
						...
						plane_normalVector_cell_widget = QWidget()
					...
					if el['shape_type_' + str(i)] == 'пластина' or el['shape_type_' + str(i)] == 'plate':
						...
						plate_normalVector_cell_widget = QWidget()
						...
						plate_span_cell_widget = QWidget()
			...
			geometry_2_btnSave = QPushButton()
